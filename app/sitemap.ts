...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: url("/guide"), lastModified, changeFrequency: "monthly", priority: 0.7 },
    { url: url("/guide/fine-dust"), lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: url("/guide/ventilation"), lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: url("/guide/air-quality-score"), lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: url("/guide/indoor-air"), lastModified, changeFrequency: "monthly", priority: 0.6 },
    { url: url("/guide/data-source"), lastModified, changeFrequency: "monthly", priority: 0.6 },
